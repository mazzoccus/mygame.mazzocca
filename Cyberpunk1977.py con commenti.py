...
class CyberpunkGame(arcade.Window):
    def __init__(self, width: int, height: int, title: str):
        ...
        # impostazioni iniziali della finestra e variabili di stato
        ...
        try:
            ...
            # se l'immagine di sfondo non è disponibile, ignoriamo l'errore
            pass

        # definizione delle stanze e dei nemici iniziali
        self.rooms = [[
    ...
    def _make_sprite(self, path: str, color: tuple[int, int, int], size: int = 20, scale: float = 0.05):
        # crea uno sprite da file o usa un rettangolo colorato come fallback
        try:
    ...
    def _shoot(self, origin_x: float, origin_y: float, target_x: float, target_y: float, speed: float, bag: list):
        # genera un proiettile verso il bersaglio con velocita normalizzata
    ...
    def _move_bullets(self, bag: list):
        # aggiorna la posizione dei proiettili tenendo conto del time_scale
        for b in bag[:]:
    ...
    def reset_game(self):
        # inizializza lo stato del gioco e i parametri del giocatore
    ...
    def setup_room(self):
        # configura i nemici per la stanza corrente
    ...
    def on_update(self, dt: float):
        # logica di aggiornamento chiamata ogni frame
        if self.current_screen != "game":
            return
        now = time.time()

        # gestione del potenziamento sandevistan (slow motion)
        ...
        # spostamento del giocatore basato sui tasti premuti
        ...
        # comportamento nemici: inseguono o sparano a seconda del tipo
        ...
        # collisione dei proiettili del giocatore con i nemici
        ...
        # collisione dei proiettili nemici con il giocatore
        ...
        # collisione diretta con i nemici (contatto)
        ...
        # raccolta degli upgrade che aumentano la velocita del giocatore
    ...
    def on_draw(self):
        # disegna la scena e l'interfaccia utente
        self.clear()
        if self.background:
        ...
        # disegna confini, giocatore, nemici, proiettili e upgrade
        ...
        # hud: integrita, stanza e numero di upgrade raccolti
        ...
        # mostra stato e timer del potenziamento sandevistan
